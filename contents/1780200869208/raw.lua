...
game.Players.PlayerAdded:Connect(function(...)
    Instance_cb44arg1.CharacterAdded.Connect(Instance_cb44arg1.CharacterAdded, function(...)
        Instance_cb44arg1.Character.WaitForChild(Instance_cb44arg1.Character, "Head", 5)
        Instance_cb48arg1:WaitForChild("Head", 5) 
    end) 
end)
...
tbl8:AddToggle({
    ["Callback"] = function(state)
        ...
        service8:GetDescendants()
        service8:GetDescendants()
        service8.DescendantAdded:Connect(function(...) Instance_cb427arg1:IsA("Seat") end)
        OrionLib:MakeNotification({
            ["Time"] = 3,
...
localPlayer632.CharacterAdded:Connect(function(...)
    local tbl5 = Instance_cb647arg1:WaitForChild("Humanoid", 5).FindFirstChild(Instance_cb647arg1:WaitForChild("Humanoid", 5), "Ragdolled")
    tbl5:IsA("BoolValue")
    tbl5:GetPropertyChangedSignal("Value").Connect(tbl5:GetPropertyChangedSignal("Value"), function(...)
        for v1, v2 in ipairs(Instance_cb647arg1:GetChildren()) do
            v662:IsA("BasePart")
...
localPlayer632.CharacterAdded:Connect(function(...)
    Instance_cb675arg1:WaitForChild("Humanoid")
    Instance_cb675arg1:WaitForChild("HumanoidRootPart") 
end)
tbl4:AddToggle({
    ["Callback"] = function(state)
...
tbl1:AddToggle({
    ["Callback"] = function(state)
        service8.ChildAdded:Connect(function(...)
            Instance_cb780arg1.Name.lower(Instance_cb780arg1.Name).find(Instance_cb780arg1.Name.lower(Instance_cb780arg1.Name), "blackhole")
            OrionLib:MakeNotification({
                ["Time"] = 8,
                ...
                ["Content"] = Instance_cb776arg1.Name .. " \xe3\x81\x8c\xe3\x82\xad\xe3\x83\x83\xe3\x82\xaf\xe3\x81\x95\xe3\x82\x8c\xe3\x81\xbe\xe3\x81\x97\xe3\x81\x9f"
            }) 
        end):Disconnect()
...
service8:GetDescendants()
service8.DescendantAdded:Connect(function(...) Instance_cb808arg1:IsA("Seat") end)
